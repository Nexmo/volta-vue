  ...
  >
    <div class="Vlt-modal__panel" @keyup.enter="confirm" @keyup.esc="close">
      ...
      <footer v-if="!noFooter" class="Vlt-modal__footer">
        ...
        <button v-if="canCancel" class="Vlt-btn Vlt-btn--app Vlt-btn--tertiary" @click="close">
          {{ getCancelText() }}
        </button>
        <button class="Vlt-btn Vlt-btn--app" :class="getPrimaryBtnClass()" @click="confirm" ref="confirmButton">
